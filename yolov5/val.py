...
def run(
    ...
    seen = 0
    confusion_matrix = ConfusionMatrix(nc=nc, iou_thres=0.01)
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'script/cigarette.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp12/weights/last.pt',
