...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'BigCoal/exp6/weights/best.pt',
                        help='model path(s)')
    parser.add_argument('--source', type=str, help='file/dir/URL/glob, 0 for webcam',
                        default='F:/MachineVision/DataSources/BeltConveyor/SplitVideo/202_233/FormatFactoryPart10.mp4')
    ...
    parser.add_argument('--half', type=bool, default=True, help='use FP16 half-precision inference')
